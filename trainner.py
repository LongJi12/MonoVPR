...
def train_model(cfg, model, eval=False):
    ...
    checkpoint_path = os.path.join(cfg.OUTPUT_DIR, 'model_0019999.pth')
    ...
    with EventStorage(start_iter) as storage:
        ...
        for data, iteration in zip(data_loader, range(start_iter, max_iter)):
            ...
            elif iteration > 20000 and iteration <= 25000 and iteration % 100 == 0:
                checkpointer.save(f"model_{iteration}.pth")
            elif iteration > 25000  and iteration % 500 == 0:
                checkpointer.save(f"model_{iteration}.pth")
